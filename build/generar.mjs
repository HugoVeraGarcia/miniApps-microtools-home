...
const ICONOS = {
  ...
  zapato: '<path d="M3 16.5c0-1.6.6-3 1.7-4l2.3-2.2c1.4-1.3 3.6-1.6 5.3-.6l1.9 1.1 4.3.9c1.6.4 2.5 1.5 2.5 2.9v1.9H3z"/>'
    + '<path d="M3 19.5h18M9.5 10.5l1 2M12 10l1 2"/>',
